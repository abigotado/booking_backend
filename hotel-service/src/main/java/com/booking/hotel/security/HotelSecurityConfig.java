...
public class HotelSecurityConfig {
    ...
    public HotelSecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter,
    ...
    public SecurityFilterChain hotelSecurityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/actuator/**", "/api/rooms/*/confirm-availability", "/api/rooms/*/release").permitAll()
